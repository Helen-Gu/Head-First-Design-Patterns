...
public class SwingCommandExample {
	...
	public void go() {
		...
		// The lambdas (ActionListeners) are the commands & actionPerformed() method
		// implementation in one.
		// We use addActionListener() to set the commands and code for the
		// actionPerformed() method
		// in the invokers (the buttons)
		// The interface that all the commands (listeners) implement is the
		// ActionListener interface.
		// This interface has one method, actionPerformed().
		// This is equivalent to the execute() method.
		// The buttons invoke the actionPerformed() method when they are clicked, which
		// is the method
